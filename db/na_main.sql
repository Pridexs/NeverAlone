...
/*PARA CORRIGIR ERRO DURANTE A INSERÇÃO É NECESSÁRIO AUTORIZAR "pais"== NULL, POIS NÃO POSSUI SELEÇÃO DE PAIS EM REGISTER.PHP*/
ALTER TABLE `users` CHANGE `pais` `pais` VARCHAR( 50 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ;
/*fim correção*/
